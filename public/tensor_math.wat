(module
 ...
 (type $11 (func (param i32 i32 i32 i32 f64 i32)))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 38640))
 (memory $0 1)
 ...
 (func $assembly/tensor_math/rolloutReward (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result f64)
  ...
  block $folding-inner0
   ...
   f64.ge
   if (result f64)
    block $__inlined_func$assembly/tensor_math/clamp$88 (result f64)
     f64.const 0
     f64.const 90
     local.get $10
     f64.sub
     ...
     f64.const 0
     f64.lt
     br_if $__inlined_func$assembly/tensor_math/clamp$88
     drop
     f64.const 1
     local.get $10
     f64.const 1
   ...
   local.set $10
   block $__inlined_func$assembly/tensor_math/clamp$89 (result f64)
    f64.const 0
    local.get $13
    f64.const 0.4
    f64.mul
    ...
    f64.const 0
    f64.lt
    br_if $__inlined_func$assembly/tensor_math/clamp$89
    drop
    f64.const 1.3
    local.get $11
    f64.const 1.3
   ...
   if
    ...
    i32.add
    global.set $~lib/memory/__stack_pointer
    block $__inlined_func$assembly/tensor_math/clamp$90 (result f64)
     f64.const -1.5
     local.get $10
     f64.const 0.35
     f64.mul
     ...
     f64.const -1.5
     f64.lt
     br_if $__inlined_func$assembly/tensor_math/clamp$90
     drop
     f64.const 1.5
     local.get $4
     f64.const 1.5
   ...
   i32.add
   global.set $~lib/memory/__stack_pointer
   block $__inlined_func$assembly/tensor_math/clamp$91 (result f64)
    f64.const -1.5
    f64.const -1
    f64.const 1
    local.get $1
    ...
    f64.const -1.5
    f64.lt
    br_if $__inlined_func$assembly/tensor_math/clamp$91
    drop
    f64.const 1.5
    local.get $4
    f64.const 1.5
